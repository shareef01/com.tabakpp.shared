...
const BurningCigarette = () => (
  <div className="relative flex flex-col items-center justify-center pointer-events-none select-none">
     ...
     <motion.div
       ...
       className="absolute w-[500px] h-[250px] bg-orange-600/10 rounded-full blur-[100px]"
     />
     <div className="absolute -top-[400px] left-0">
        {[...Array(8)].map((_, i) => (
          <motion.div
            ...
            className="absolute w-32 h-32 bg-white/[0.02] rounded-full blur-[80px]"
          />
        ))}
     </div>
  </div>
...
export const AuthScreen = ({ accent }) => {
