 ...
 * integrated Crimson-red progress gauge.
 */
const QuitControlIcon = React.memo(() => (
  <div className="relative flex flex-col items-center justify-center pointer-events-none select-none group">
    {/* Atmospheric Depth - Now Red */}
    <div className="absolute inset-0 bg-rose-600/10 blur-[120px] rounded-full scale-150 animate-pulse" />
    ...
    <svg width="440" height="100" viewBox="0 0 440 100" fill="none" xmlns="http://www.w3.org/2000/svg" className="relative drop-shadow-[0_25px_60px_rgba(0,0,0,0.6)]">
      ...
      <motion.rect
        ...
        className="drop-shadow-[0_0_12px_#FF3B30]"
      />

      {/* Pulse Sensor */}
      <circle cx="305" cy="52" r="14" fill="#050505" stroke="#FF3B30" strokeWidth="1" strokeOpacity="0.4" />
      <motion.circle
        animate={{ r: [6, 8, 6], opacity: [0.4, 0.8, 0.4] }}
        transition={{ duration: 1, repeat: Infinity }}
        cx="305" cy="52" r="6" fill="#FF3B30"
      />
    </svg>

    {/* Crimson Particle Flow */}
    <div className="absolute inset-0 flex items-center justify-center">
      {[...Array(6)].map((_, i) => (
        <motion.div
          ...
          className="absolute w-24 h-24 bg-rose-600/5 rounded-full blur-3xl"
        />
      ))}
    </div>
  </div>
...
export const AuthScreen = React.memo(({ accent }) => {
  ...
  return (
    <div className="min-h-screen bg-[#020202] flex flex-col lg:flex-row items-stretch text-white font-inter overflow-hidden selection:bg-rose-600/30 relative">
      <div className="absolute top-10 left-10 lg:top-16 lg:left-16 z-[100] flex flex-col items-start font-inter pointer-events-none">
         <h1 className="text-4xl lg:text-5xl font-[1000] tracking-tighter uppercase leading-none whitespace-nowrap">TABAK<span className="text-rose-600">++</span></h1>
        ...
        <div className="w-full max-w-[520px] flex flex-col items-center">
          <div className="bg-neutral-900/40 backdrop-blur-3xl border border-white/5 p-10 lg:p-14 rounded-[56px] shadow-2xl shadow-black/50 relative overflow-hidden font-inter w-full text-center">
             ...
             <div className="flex flex-col gap-8 relative z-10 font-inter text-center">
               ...
               {/* PREMIUM MULTI-LAYERED BUTTON - Now Wider and Crimson */}
               <button
                className="group relative w-full h-20 bg-rose-600 text-zinc-950 font-[1000] uppercase tracking-[0.4em] rounded-2xl active:scale-[0.98] transition-all overflow-hidden flex items-center justify-center text-[12px] mt-4 shadow-[0_15px_50px_rgba(225,29,72,0.3)]"
                onClick={handle}
               >
