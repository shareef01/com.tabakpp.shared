...
const APP_VERSION = "8.5.0-STABLE";
    ...
    <div className="min-h-screen bg-[#020202] flex items-center justify-center p-6 text-white font-inter relative overflow-hidden">
      ...
      <div className="w-full max-w-md space-y-12 relative z-10">
        <motion.div initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} transition={{ type: 'spring', damping: 20 }} className="flex flex-col items-center text-center">
          ...
          <p className="mt-8 text-accent/50 font-black tracking-[0.6em] uppercase text-[10px]">Registry Portal Active</p>
        </motion.div>
            ...
            <div className="flex flex-col space-y-8">
              ...
              <div className="flex flex-col space-y-6 items-center pt-8 border-t border-white/5 mt-6">
                <button onClick={() => setIsL(!isL)} className="text-[11px] font-[1000] text-text-dim uppercase tracking-[0.3em] hover:text-accent transition-all decoration-accent underline-offset-8">
                  {isL ? "Request New Access" : "Return to Log In"}
                </button>
  ...
  return (
    <Card className={cn("relative flex flex-col group transition-all duration-1000 p-8 md:p-14 overflow-hidden shadow-2xl rounded-[64px] font-inter", isL ? "bg-danger/[0.04] border-danger/50 shadow-[0_0_80px_rgba(248,113,113,0.15)]" : (isDark ? "bg-white/[0.03] border-white/5 shadow-black/20" : "bg-white border-black/5 shadow-black/5 shadow-2xl"), isC ? "min-h-[400px]" : "min-h-[500px] md:min-h-[620px]")}>
       ...
       <div className="flex-1 flex flex-col items-center justify-center relative z-10 w-full overflow-hidden py-4">
          {(isCig || isJoint) ? (
             <div className={cn("relative w-full max-w-[280px] h-14 md:h-16 rounded-full overflow-hidden transition-all duration-1000 border-2 shadow-2xl", isL ? "bg-danger border-danger/40" : (isDark ? "bg-[#111] border-white/10 shadow-[inset_0_4px_30px_rgba(0,0,0,0.9)]" : "bg-[#DDD] border-black/5 shadow-inner"))}>
             ...
             <div className="relative w-36 h-36 md:w-52 md:h-52 flex items-center justify-center shrink-0">
          ...
          <div className="flex items-center space-x-10 md:space-x-14 mb-14 md:mb-20 relative z-10">
             ...
             <div className="space-y-4 min-w-0">
                ...
                <div className="flex items-center space-x-4">
                   ...
                   <span className="text-[12px] font-black uppercase tracking-[0.5em] text-accent/60 font-inter">Verified Registry</span>
                </div>
             </div>
          </div>
          <div className="space-y-12 relative z-10">
             <Input label="Registry Identity" value={al} onChange={setAl} isDark={s.isDark} />
             <button className="w-full h-22 rounded-full bg-accent text-bg-base shadow-[0_20px_60px_var(--accent-rgb)] font-[1000] uppercase tracking-[0.4em] active:scale-95 transition-all text-xs flex items-center justify-center" onClick={() => onUpd({ displayName: al })} style={{'--accent-rgb': `rgba(${hexToRgb(s.accent)}, 0.4)`}}>Update Identification</button>
          </div>
       </Card>
          ...
          <div className="flex flex-col space-y-12">
             ...
             <div className={cn("p-12 rounded-[56px] border-2 space-y-14 shadow-inner transition-all mt-10", s.isDark ? "bg-black/50 border-white/5 shadow-black/60" : "bg-[#F0F2F5] border-black/5 shadow-inner")}>
                ...
                <div className="flex flex-wrap gap-6 justify-center">
                   {ACCENTS.map(x => (
                      <button key={x.v} onClick={() => setLa(x.v)} className={cn("w-16 h-16 md:w-18 md:h-18 rounded-[24px] border-[5px] transition-all duration-700 shadow-2xl active:scale-90 relative", la === x.v ? "border-white scale-115 shadow-accent/60" : "border-transparent opacity-30 hover:opacity-100")} style={{ backgroundColor: x.v }}>
...
const AddForm = ({ onAdd, isDark, accent }) => {
  ...
  return (
    <div className="space-y-14">
       <Input label="Registry Label" value={n} onChange={setN} placeholder="e.g. Unit A" isDark={isDark} />
